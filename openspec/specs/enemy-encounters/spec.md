...
- **WHEN** the elapsed time since the last garbage insertion reaches the effective interval
- **THEN** one garbage row is inserted at the bottom of the board and the timer resets
